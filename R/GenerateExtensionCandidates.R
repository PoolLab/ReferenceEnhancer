...
#'
#' @description Identifies candidate genes for extension with excess 3' intergenic reads
...
#'
#' @return Rank ordered list of gene extension candidates saved to working directory as gene_extension_candidates.csv
#' @export
#'
#' @examples
